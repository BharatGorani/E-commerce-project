      ...
      <div>
        ...
        <table>
          ...
          <tbody>
            {this.state.productList.map((items, index) => (
              <tr key={index}>
                <td onClick={(event) => this.displayBox(event, items.id)}>
                  {items.name}
                </td>
                <td>{items.brand.name}</td>
                <td>{items.category.name}</td>
                <td>
                  {Array.isArray(items.specification) ? (
        ...
        {this.state.particularProduct.name ? (
          <div className="particular-product">
            ...
            <div className="product-detail">
              Specification:{" "}
              {Array.isArray(this.state.particularProduct.specification) ? (
                this.state.particularProduct.specification.map((items, index) => (
